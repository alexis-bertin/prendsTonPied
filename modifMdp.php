...
<html>
 ...
 <body>
 	...
 	<?php
 		if (isset($message)) { 
			echo "<span class='alert'>Mot de passe incorrect</span>";
		}
		if (isset($message2)) { 
			echo "<span class='alert'>Les mots de passe ne correspondent pas</span>";
		}
		if (isset($_SESSION['message3'])) { 
			echo "<span class='alert'>Changement de mot de passe effectué</span>";
		}
		if (isset($message4)) { 
			echo "<span class='alert'>Veuillez remplir tous les champs</span>";
		}
		if (isset($message5)) { 
			echo "<span class='alert'>Votre nouveau mot de passe doit comporter au moins un chiffre, un caractère spécial et 8 caractères ou plus</span>";
		}
		$_SESSION['message3']=NULL;
	?>
 	<br/><form method="POST" action="changerMdp.php">
		<table>
			<tr><td>Ancien mot de passe : </td><td><input name="obli[ancien]" type="password"></input></td></tr>
			<tr><td>Nouveau mot de passe : </td><td><input name="obli[new]" type="password"></input></td></tr>
			<tr><td>Confirmer mot de passe : </td><td><input name="obli[new2]" type="password"></input></td></tr>
		</table>
